...
.field protected secondClass SecondClass;
.field protected firstClass FirstClass;
...
.method public test()Z
   ...
   putfield TestInheritedClasses/expect Expect;
   aload_0
   new SecondClass
   dup
   invokespecial SecondClass/<init>()V
   putfield TestInheritedClasses/firstClass FirstClass;
   getstatic java/lang/System/out Ljava/io/PrintStream;
   ldc "Inherited Classes:"
   invokevirtual java/io/PrintStream/println(Ljava/lang/String;)V
   aload_0
   getfield TestInheritedClasses/firstClass FirstClass;
   bipush 13
   invokevirtual FirstClass/setFirstInt(I)Z
   istore 2
   aload_0
   getfield TestInheritedClasses/expect Expect;
   aload_0
   getfield TestInheritedClasses/firstClass FirstClass;
